	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<a href="${pageContext.request.contextPath}/kdh/kdhPofol.do" class="logo"><span>Home...</span></a>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
						...
						<!-- One -->
							<section id="one">
								<div class="inner">
									...
									<span class="image main"><img src="${pageContext.request.contextPath}/resources/images/man.png" alt="" /></span>
